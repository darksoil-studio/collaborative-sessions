...

{
  perSystem =
    ...
    , ...
      ...
      packages.real_time_sessions_test_dna = inputs.holochain-nix-builders.outputs.builders.${system}.dna {
        ...
        zomes = {
          ...
          real_time_sessions_integrity = self'.packages.real_time_sessions_integrity;
